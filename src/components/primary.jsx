                    ...
                    <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-white overflow-hidden md:px-8 md:flex">
                        <div className='flex-none space-y-5 max-w-xl'>
                            ...
                            <h1 className="text-4xl text-white font-extrabold sm:text-5xl">
                                VIBES PROJECT: Make your own ~vibe~.
                            </h1>
                            <p>
                            The Vibes Project introduces wearable vibration therapy for muscular atrophy, using controlled vibrations to strengthen muscles and enhance mobility. This innovative approach empowers individuals with improved well-being and quality of life.                            </p>
